...
var CartesianAxisValueMapper = /** @class */ (function () {
    ...
    CartesianAxisValueMapper.prototype.onTicksColorChanged = function (oldValue, newValue, axis) {
        if (newValue) {
            axis.android.setTickColor((new color_1.Color(newValue)).android);
        }
    };
...
var SplineSeriesValueMapper = /** @class */ (function () {
    ...
    SplineSeriesValueMapper.prototype.onLegendTitleChanged = function (newValue, series) { };
