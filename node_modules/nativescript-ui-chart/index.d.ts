...
declare class Trackball extends ViewBase {
    ...
    */
    ...
    /**
    * Gets or sets the snap mode of the trackball. Must be one of the constants listed in {@link TrackballSnapMode}.
    */
    snapMode: string;
...
declare class CartesianAxis extends ViewBase {
    ...
    */
    public static ticksColorProperty: Property<CartesianAxis, string>;
