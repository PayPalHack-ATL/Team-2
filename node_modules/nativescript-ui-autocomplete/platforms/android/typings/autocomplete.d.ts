	...
	export module telerik {
		export module widget {
			export module autocomplete {
				export class AutoCompleteAdapter extends globalAndroid.support.v7.widget.RecyclerView.Adapter<com.telerik.widget.autocomplete.SuggestionItemViewHolder> implements com.telerik.widget.autocomplete.AutoCompleteAdapterBase  {
		...
		export module widget {
			export module autocomplete {
				export class RadAutoCompleteTextView extends com.telerik.widget.primitives.panels.RadScrollView implements globalAndroid.view.ViewTreeObserver.OnGlobalLayoutListener {
					...
					public getSuggestionView(): globalAndroid.support.v7.widget.RecyclerView;
...
declare module com {
	export module telerik {
		export module widget {
			export module autocomplete {
				export class SuggestionItemViewHolder extends globalAndroid.support.v7.widget.RecyclerView.ViewHolder {
